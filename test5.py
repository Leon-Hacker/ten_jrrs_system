...
class MainController(QWidget):
    ...
    def start_long_task(self):
        ...
        self.worker.long.emit()  # This will block the worker thread for 5 seconds

    def trigger_quick_task(self):
        """Trigger a quick task in the worker thread."""
        self.worker.quick.emit()  # This shows that the worker thread can still process events
